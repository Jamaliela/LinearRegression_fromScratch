...
def correlation_coefficient(predicted_values,test_values):
    a = predicted_values
    b = test_values
    n = len(a)
    two_sum = numpy.sum(a*b)
...
def main():
    """
    The main function where all the other methods will be used for our data
    """


data = pd.read_csv('Agg_data.csv')  # Importing data using pandas library
...
print(correlation_coefficient(test_values=Y_validation, predicted_values=predictions))
